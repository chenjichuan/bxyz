          ...
          <TabPane label="产品详情" name="1">
            <div style="display:flex;margin-top: 36px;">
              ...
              <div class="right-text">
                <p>顾问服务产品说明</p>
                <ul>
                  <li>金卡法律顾问：包括20次法律咨询，10份合同审查。 </li>
                  <li>银卡法律顾问：包括10次法律咨询，6份合同审查。</li>
                </ul>
              </div>
            </div>
            <div style="display:flex;margin-top: 36px;">
              ...
              <div class="right-text">
                ...
                <ul>
                  ...
                  <li>请您在输入问题时将购买产品及需求进行描述，咨询问题类，直接将问题提出即可，如需合同审查，请提问时一并将合同上传。  </li>
                  <li>工作人员收到您的请求后，会尽快给您回复，请您到会员中心“我的问题”中查看回复。</li>
                </ul>
              </div>
            </div>
          </TabPane>
